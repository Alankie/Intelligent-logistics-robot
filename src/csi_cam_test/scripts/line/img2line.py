...
class find_line:
    ...
    def callback_start(self, data):
        # print('judge line start or not',end='')
        cv_con = data.data
        print(cv_con, end='')
        ...
        if cv_con == 4:
            self.start_line = -1
            self.array[0] = 1
            print('end the line,go straight')
    ...
    def callback(self, data):
        print('go into callback_line', self.start_line)
